...
const perguntas = [
    {
        ...
        alternativas: ["Não me preocupo com isso", "Sim, com toda a certeza!"
            
        ]
    },
    {
        enunciado: "Como a desigualdade social afeta o acesso  a educação de qualidade?",
        alternativas: ["Faz com que pessoas com maior poder aquisitivo tenha uma educação de maior qualidade.",
...

    {
        ...
        alternativas: [ "Distribuição de renda e baixa qualificação profissional. A educação pode ser a ferramenta para conscientizar a sociedade.",
